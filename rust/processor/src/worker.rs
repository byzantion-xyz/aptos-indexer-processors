...
pub fn build_processor(
    ...
    match config {
        ...
        ProcessorConfig::MercatoRecentDataProcessor => Processor::from(
            MercatoRecentDataProcessor::new(db_pool, per_table_chunk_sizes),
        ),
    }
}
