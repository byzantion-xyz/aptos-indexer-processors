...
async fn main() -> Result<(), tokio_postgres::Error> {
    ...
    for table in ["events", "transactions", "user_transactions", "signatures",
        "current_collection_datas", "current_collections_v2", "current_token_datas", "current_token_datas_v2", "current_token_ownerships", "current_token_ownerships_v2", "current_token_v2_metadata"
    ] {
        println!("table: {}", table);
